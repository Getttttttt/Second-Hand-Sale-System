...
export default function SignInForMerchant() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8080/SecondHandSystemAPIs_war_exploded/merchant/signIn', {
        method: 'POST',
        headers: myHeaders,
        body: jsonData,
      });
      ...
      console.log(signInData.merchantID);
