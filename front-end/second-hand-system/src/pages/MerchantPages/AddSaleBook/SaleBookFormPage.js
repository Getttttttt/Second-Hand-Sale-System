...
const SaleBookFormPage = () => {
  ...
  const handleAddBook = async ({list}) => {  //新增图书
    ...
    //数据传回后端
    addBook({newBookId: bookId,newBookName: newBookName,newBookPrice: newBookPrice,newBookDiscount: newBookDiscount,newBookQuantity: newBookQuantity,newBookCondition: newBookCondition,
